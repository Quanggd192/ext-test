...
import RecomendedItem, {
  IRecomendedItem,
} from "Components/MenuItem/RecomendedItem";
...
export default function RecomendedList() {
  return (
    <div className="flex flex-wrap justify-between">
      {listRecomendedItems.map((item: IRecomendedItem, index: number) => (
        <div
          className="lg:w-[23%] w-full md:w-[31%] sm:w-[47%] mb-[15px]"
          key={`recomended-menu-${index}`}
        >
