...
export default function HexagonMenu() {
  ...
  return (
    <div className="flex md:flex-no-wrap flex-wrap items-center justify-center py-[30px]">
      {listHexagonItems.map((item: any, index: number) => (
        <div onClick={() => dispatch(setType(item.text.toLowerCase()))}>
          <HexagonMenuItem
